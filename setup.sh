...
patch_port() {
  if [ "$CHATBOT_PORT" != "8000" ]; then
    log "Setting chatbot port to $CHATBOT_PORT …"
    sed -i "s|\"8000:8000\"|\"${CHATBOT_PORT}:8000\"|g" "$REPO_DIR/docker-compose.yml"
  fi
}
...
print_summary() {
  ...
  ok "Setup complete!"
  echo ""
  echo "  Chatbot UI  →  http://${PUBLIC_IP}:${CHATBOT_PORT}"
  ...
  echo ""
  echo "  AWS Security Group: make sure port ${CHATBOT_PORT} is open for inbound TCP."
  echo "━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━"
}
